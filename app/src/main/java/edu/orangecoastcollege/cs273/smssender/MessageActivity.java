...
public class MessageActivity extends AppCompatActivity {
    ...
    private static final int ADD_CONTACT_REQUEST_CODE = 100;
    private static final int SEND_SMS_REQUEST_CODE = 101;
    ...
    public void addContacts(View view) {
        ...
        startActivityForResult(contactIntent, ADD_CONTACT_REQUEST_CODE);
    ...
    public void deleteContact(View view) {
        ...
        if(view instanceof LinearLayout)
        {
            ...
            Toast.makeText(this, "Contact Deleted: " + selectedContact.getName(),
    ...
    public void sendTextMessage(View view) {
        ...
        if (message.isEmpty()) {
            Toast.makeText(this, "Please enter a message text.",
                    Toast.LENGTH_SHORT).show();
            return;
        }
        if (contactsList.isEmpty()) {
            Toast.makeText(this, "Please add a contact",
                    Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.SEND_SMS)
            ...
            //Define reference to sms manager (manages text messages
            SmsManager manager = SmsManager.getDefault();

            //For each loop through contacts
